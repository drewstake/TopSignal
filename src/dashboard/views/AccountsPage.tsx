      ...
      <div className="rounded-2xl border border-zinc-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900/40 p-5">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={() => load(true)}
              className="rounded-xl border border-zinc-300 bg-white dark:border-zinc-800 dark:bg-zinc-950/40 px-3 py-2 text-sm text-zinc-800 dark:text-zinc-200"
            >
              Refresh
            </button>
          </div>
        ...
        {!connected ? (
          <div className="mt-4 rounded-xl border border-zinc-200 bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-950/30 px-3 py-2 text-sm text-zinc-800 dark:text-zinc-200">
        ...
        <div className="mt-4 overflow-hidden rounded-2xl border border-zinc-800">
          <div className="grid grid-cols-12 bg-zinc-950/40 px-4 py-2 text-xs text-zinc-600 dark:text-zinc-400">
                ...
                return (
                  ...
                  >
                    <div className="col-span-4">
                      ...
                      <div className="mt-0.5 text-xs text-zinc-600 dark:text-zinc-400">ID: {a.id}</div>
                    </div>
                    ...
                    <div className="col-span-2 flex justify-end">
                      <button
                        ...
                        className="rounded-xl border border-zinc-300 bg-white dark:border-zinc-800 dark:bg-zinc-950/40 px-3 py-2 text-xs text-zinc-800 dark:text-zinc-200"
                      >
                        Set active
                      </button>
                    </div>
        ...
        <div className="mt-4 rounded-xl border border-zinc-200 bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-950/30 px-3 py-2 text-xs text-zinc-600 dark:text-zinc-400">
          Using: POST <span className="text-zinc-800 dark:text-zinc-200">/api/Account/search</span>
        </div>
      </div>
    </div>
  );
