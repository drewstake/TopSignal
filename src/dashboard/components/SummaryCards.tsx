...
function MetricCard({ label, value, sub, description }: MetricCardData) {
  return (
    <div className="rounded-2xl border border-zinc-800 bg-zinc-950/30 p-4">
      <div className="flex items-start justify-between gap-2 text-xs text-zinc-400">
        <span>{label}</span>
  ...
  return (
    <div className="group relative flex-shrink-0">
      <button
        ...
        className="flex h-5 w-5 items-center justify-center rounded-full border border-zinc-700 text-[10px] font-semibold text-zinc-200 transition hover:border-zinc-500 hover:text-zinc-100 focus:border-zinc-400 focus:text-zinc-100 focus:outline-none"
      >
        i
      </button>
